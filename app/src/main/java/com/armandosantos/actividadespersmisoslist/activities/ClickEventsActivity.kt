...
class ClickEventsActivity : AppCompatActivity(), View.OnLongClickListener {
    ...
    //eL metodo tiene que ser publico, nombre tienen que coincidir, y recibe solo parametro(View)
    ...
    override fun onLongClick(view: View): Boolean {
        when (view.id) {
            R.id.buttonClickMulti1 -> Toast.makeText(
                this,
                "Click Multi 1!",
                Toast.LENGTH_SHORT
            ).show()
            R.id.buttonClickMulti2 -> Toast.makeText(
                this,
                "Click Multi 2!",
                Toast.LENGTH_SHORT
            ).show()
            R.id.buttonClickMulti3 -> Toast.makeText(
                this,
                "Click Multi 3!",
                Toast.LENGTH_SHORT
            ).show()
