...
class PermissionsActivity : AppCompatActivity() {
    ...
    private fun getPictureFromCamera() {
        ...
        if (pictureIntent.resolveActivity(packageManager) != null) {
            ...
            //No hay activity que pueda manejar el intent (no hay camara)
        }
    }
    ...
    private fun getPictureFromCameraAskingPermissions() {
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            //Si ah sido aceptado previamente (Para versiones anteriores a la 6.0[API 23])
        ...
        when (requestCode) {
            requestCameraPicture -> {
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    //Cargamos la foto del bitmap en el imageView
